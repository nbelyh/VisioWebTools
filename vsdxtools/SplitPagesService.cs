...
{
    private static string MakeSafeFileName(string unsafeFileName)
    {
    ...
    private static HashSet<string> GetRelatedPages(string pageId, List<PageInfo> infos)
    {
    ...
    private static void RemovePagesExcept(Stream stream, HashSet<string> pagesToKeep, DocumentInfo info)
    {
    ...
    private static DocumentInfo GetPageInfos(Stream stream)
    {
