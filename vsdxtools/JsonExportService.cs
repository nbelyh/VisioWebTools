...
{
    private static void ProcessMasters(Package package, PackagePart documentPart, Func<Dictionary<string, MasterInfo>> getMasterInfos)
    {
    ...
    private static void GetDocumentProperties(Package package, DocumentInfo documentInfo)
    {
    ...
    private static void ProcessPages(Package package, PackagePart documentPart, JsonExportOptions options, Func<Dictionary<string, PageInfo>> getPages)
    {
    ...
    private static DocumentInfo ProcessDocument(Stream stream, JsonExportOptions options)
    {
