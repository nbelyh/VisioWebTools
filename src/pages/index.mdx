...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
  ...
  <ToolCard
    href="/chipher"
    title="Chipher Tool (preview)"
    imageSrc="/chipher-flow.svg"
    body="This tool allows you to chipher text in Visio shapes. It can be used to hide sensitive information in Visio diagrams. The tool uses a simple substitution cipher, where each character is replaced with a different one."
  />
  <ToolCard
